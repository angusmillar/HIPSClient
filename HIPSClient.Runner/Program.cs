...
namespace HIPSClient.Runner
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      Msg.Add(@"PID|||0000020^^^^MR~4950827451^^^AUSHIC^MC~8003608333513877^^^AUSHIC^NI||CURRY^ELLENS^^^Ms^^L||20030915|F||1^Aboriginal but not Torres Strait Islander origin^ISAAC|^9 HERB AVE^BROADBEACH^^4218^AUS^H|||^PRN^PH^^^^93235615|^WPN^CP^^^^0414778341");
